...
public class AttrController {
    ...
    @GetMapping
    public Resp<PageVo> queryAttrByCid(@PathVariable(value = "type" ,required = false)Integer type,@PathVariable(value = "cid",required = false)Long cid ,QueryCondition condition){
